...
class mainController extends Controller
{
  public function dashboard(Request $request, $region = 'BANDUNG') {
    $response = Http::get("https://sheets.googleapis.com/v4/spreadsheets/17JHm_VIMaJG3D_JADeCYWFTxRUiKe7LTTTXCZjAlhmU/values/FDT_FAT!A5:N20?key=AIzaSyCwOuZAm8MkSet-tEv7sYCrkFUx8HSsAnk&majorDimension=ROWS");
    $data = $response->json();
