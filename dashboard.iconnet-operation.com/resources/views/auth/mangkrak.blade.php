...
<div class="container">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div>
                <img src="{{asset('assets/img/iconnet/mangkrak.png')}}" alt="" style="width: 500px">
              </div>
              <h3 class="text-center mt-3">Project ini mangkrak, <br> perusahaan tidak mampu membayar programmer</h3>
    ...
    <section aria-details="link script js">
      ...
      {{-- GOOGLE MAP API --}}
      <script src="{{ asset('assets/js/dashboard/map.js') }}" rel="stylesheet"> </script>
      <script src="https://polyfill.io/v3/polyfill.min.js?features=default"></script>
      <script
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC2g2YYM0fhfzVJsNL36PKoMtWFQ4v1nTM&callback=initMap&v=weekly"
      defer
      ></script>
